...
N = 1900  # Change this to select how many last rows you want to plot for one cycle
...
ax.plot(x1, x2, x3, lw=2, marker='o', markersize=4,color='red')
...
#=================================================
# Initial condition
x1int, x2int, x3int = 0.0190, 0.1430, 0.1578
...
ax.plot(trajectory[-2500:,0],trajectory[-2500:,1], trajectory[-2500:,2], lw=1.0, marker='o', markersize=2,color='red')
# #==================================
# #trajectory number 2
# #==================================
# Initial condition
...
ax.plot(trajectory[-2000:,0],trajectory[-2000:,1], trajectory[-2000:,2], lw=1.0, marker='o', markersize=2,color='red')
