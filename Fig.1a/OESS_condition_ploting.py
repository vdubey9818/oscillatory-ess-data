...
labels = [" ", "0", " "]
all_ticks = [0, (N-1)//2, N-1]

print(all_ticks)
ax.set_xticks(all_ticks)
ax.set_yticks(all_ticks)
ax.set_zticks(all_ticks)
...
ax.set_xlabel(r"$\epsilon_1$", fontsize=50, labelpad=15)
ax.set_ylabel(r"$\epsilon_2$", fontsize=50, labelpad=15)
ax.set_zlabel(r"$\epsilon_3$", fontsize=50, labelpad=15)
